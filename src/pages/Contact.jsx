    ...
    <section className="section" ref={revealRef}>
      ...
      <div className="contact-content">
        ...
        <a href="/resume.html" target="_blank" rel="noopener noreferrer" className="mailto-btn mailto-btn--ghost fade-up">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><path d="M16 13H8" /><path d="M16 17H8" /></svg>
          View my CV
        </a>
        ...
        <div className="contact-details fade-up">
          ...
          <div className="contact-item">
            <div className="contact-icon">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 10v6M2 10l10-5 10 5-10 5z" /><path d="M6 12v5c3 3 6 3 12 0v-5" /></svg>
            </div>
        ...
        <div className="social-row fade-up">
          ...
          <a href="https://www.facebook.com/michael.harvy.minebe.nepomuceeno.30" title="Facebook" target="_blank" rel="noopener noreferrer">
